...
```
![image](https://github.com/DevStarSJ/Study/blob/master/Blog/Oracle/sqlp/image/02.02.sql.adv.01.png?raw=true)
...
```
![image](https://github.com/DevStarSJ/Study/blob/master/Blog/Oracle/sqlp/image/02.02.sql.adv.02.png?raw=true)
...
```
![image](https://github.com/DevStarSJ/Study/blob/master/Blog/Oracle/sqlp/image/02.02.sql.adv.03.png?raw=true)
...
```
![image](https://github.com/DevStarSJ/Study/blob/master/Blog/Oracle/sqlp/image/02.02.sql.adv.04.png?raw=true)
...
```
![image](https://github.com/DevStarSJ/Study/blob/master/Blog/Oracle/sqlp/image/02.02.sql.adv.05.png?raw=true)
...
```
![image](https://github.com/DevStarSJ/Study/blob/master/Blog/Oracle/sqlp/image/02.02.sql.adv.06.png?raw=true)
...
SELECT DEPTNO, ENAME, SAL,
 ...
 ORDER BY DEPTNO, SAL;
```
![image](https://github.com/DevStarSJ/Study/blob/master/Blog/Oracle/sqlp/image/02.02.sql.adv.07.png?raw=true)
...
SELECT *
 ...
 WHERE ROWNUM <= 2;
```
![image](https://github.com/DevStarSJ/Study/blob/master/Blog/Oracle/sqlp/image/02.02.sql.adv.08.png?raw=true)
...
```
![image](https://github.com/DevStarSJ/Study/blob/master/Blog/Oracle/sqlp/image/02.02.sql.adv.09.png?raw=true)
