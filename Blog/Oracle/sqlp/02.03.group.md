...
SELECT DNAME, JOB, COUNT(*) AS TOTAL_EMP, SUM(SAL) AS SUM_SAL
 ...
 ORDER BY DNAME, JOB;
```
![image](https://github.com/DevStarSJ/Study/blob/master/Blog/Oracle/sqlp/image/02.03.group.01.png?raw=true)
...
SELECT 'TOTAL' AS DNAME, '' AS JOB, COUNT(*) AS TOTAL_EMP, SUM(SAL) AS SUM_SAL, 3 AS DEPTH
  FROM EMP
```
![image](https://github.com/DevStarSJ/Study/blob/master/Blog/Oracle/sqlp/image/02.03.group.02.png?raw=true)
...
```
![image](https://github.com/DevStarSJ/Study/blob/master/Blog/Oracle/sqlp/image/02.03.group.03.png?raw=true)
...
SELECT DNAME, JOB, COUNT(*) AS TOTAL_EMP, SUM(SAL) AS SUM_SAL
 ...
 ORDER BY DNAME, JOB;
```
![image](https://github.com/DevStarSJ/Study/blob/master/Blog/Oracle/sqlp/image/02.03.group.04.png?raw=true)
...
SELECT DECODE (GROUPING(DNAME), 1, 'Total DEPT', DNAME) AS DNAME,
 ...
 GROUP BY ROLLUP (DNAME, JOB);
```
![image](https://github.com/DevStarSJ/Study/blob/master/Blog/Oracle/sqlp/image/02.03.group.05.png?raw=true)
