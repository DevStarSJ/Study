...
* Log Buffer
  ...
  - DB Block Buffer에 기록하기 전에 Redo Log Buffer에 먼저 기록. LGWR이 주기적으로 Redo Logfile에 기록.
  - Dirty Buffer를 datafile에 기록하기 전에 항상 Log Buffer를 먼저 Logfile에 기록
  - 왜냐면 인스턴스 장애 발생시 commit하지 않은 transaction을 rollback하기 위함
