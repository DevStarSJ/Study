...
SELECT ENAME, SAL, JOB,
  ...
  FROM EMP
```
![image](https://github.com/DevStarSJ/Study/blob/master/Blog/Oracle/sqlp/image/02.04.window.12.png?raw=true)
...
SELECT DEPTNO, ENAME, SAL,
  ...
  FROM EMP
```
![image](https://github.com/DevStarSJ/Study/blob/master/Blog/Oracle/sqlp/image/02.04.window.13.png?raw=true)
...
SELECT ENAME, SAL,
  ...
  FROM EMP;
```
![image](https://github.com/DevStarSJ/Study/blob/master/Blog/Oracle/sqlp/image/02.04.window.14.png?raw=true)
