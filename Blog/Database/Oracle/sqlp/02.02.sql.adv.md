...
```
![image](image/02.02.sql.adv.01.png)
...
```
![image](image/02.02.sql.adv.02.png)
...
```
![image](image/02.02.sql.adv.03.png)
...
```
![image](image/02.02.sql.adv.04.png)
...
```
![image](image/02.02.sql.adv.05.png)
...
```
![image](image/02.02.sql.adv.06.png)
...
SELECT DEPTNO, ENAME, SAL,
 ...
 ORDER BY DEPTNO, SAL;
```
![image](image/02.02.sql.adv.07.png)
...
SELECT *
 ...
 WHERE ROWNUM <= 2;
```
![image](image/02.02.sql.adv.08.png)
...
```
![image](image/02.02.sql.adv.09.png)
